...
if operasi == "A" or operasi == "a":
    ...
    hasil = bilangan_1 - bilangan_2 
    print(f'hasil pengurangan adalah : {bilangan_1} - {bilangan_2} = {hasil}')
    print("Kalkulator Berhasil, Terima Kasih !")
elif operasi == "C" or operasi == "c":
    hasil = bilangan_1 * bilangan_2 
    print(f'hasil perkalian adalah : {bilangan_1} * {bilangan_2} = {hasil}')
    print("Kalkulator Berhasil, Terima Kasih !")
elif operasi == "D" or operasi == "d":
    hasil = bilangan_1 / bilangan_2 
    print(f'hasil pembagian adalah : {bilangan_1} / {bilangan_2} = {hasil}')
    print("Kalkulator Berhasil, Terima Kasih !")
elif operasi == "E" or operasi == "e":
    hasil = bilangan_1 % bilangan_2 
    print(f'hasil sisa bagi adalah : {bilangan_1} % {bilangan_2} = {hasil}')
    print("Kalkulator Berhasil, Terima Kasih !")
elif operasi == "F" or operasi == "f":
    hasil = bilangan_1 ** bilangan_2 
    print(f'hasil perpangkatan adalah : {bilangan_1} ** {bilangan_2} = {hasil}')
    print("Kalkulator Berhasil, Terima Kasih !")
elif operasi == "G" or operasi == "g":
    hasil = bilangan_1 // bilangan_2 
    print(f'hasil pembagian bulat adalah : {bilangan_1} // {bilangan_2} = {hasil}')
    print("Kalkulator Berhasil, Terima Kasih !")
else :
